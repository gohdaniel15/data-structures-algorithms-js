export function mergeSortedArrays(array1: Array<number | undefined>, array2: Array<number | undefined>): Array<number | undefined> {
  if (typeof array1.length !== 'number' || typeof array2.length !== 'number') return []
